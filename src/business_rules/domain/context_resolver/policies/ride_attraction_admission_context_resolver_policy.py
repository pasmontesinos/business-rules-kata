...
from business_rules.domain.context_resolver.specifications.has_capacity_available_specification import (
    HasCapacityAvailableSpecification,
)
from business_rules.domain.context_resolver.specifications.has_favorable_weather_specification import (
    HasFavorableWeatherSpecification,
)
from business_rules.domain.context_resolver.specifications.is_attraction_open_specification import (
    IsAttractionOpenSpecification,
)
from business_rules.domain.context_resolver.specifications.is_attraction_operational_specification import (
    IsAttractionOperationalSpecification,
)
from business_rules.domain.context_resolver.specifications.is_tall_enough_specification import (
    IsTallEnoughSpecification,
)
from business_rules.domain.context_resolver.specifications.requires_fast_pass_during_peak_for_popular_specification import (
...
class RideAttractionAdmissionContextResolverPolicy:
    def __init__(
        self,
        metrics_recorder: MetricsRecorder,
        specs_to_unsatisfied_outcome: dict[
            RideAttractionContextResolverSpecification, Decision.Outcome
        ],
    ) -> None:
    ...
    ) -> RideAttractionAdmissionContextResolverPolicy:
        return cls(
    ...
    def decide(self, context: RideAttractionContextResolver) -> Decision:
