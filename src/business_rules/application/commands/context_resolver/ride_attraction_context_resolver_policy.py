...
from business_rules.domain.context_resolver.policies.ride_attraction_admission_context_resolver_policy import (
...
class RideAttractionContextResolverPolicyCommandHandler(RideAttractionCommandHandler):
    def __init__(
        self,
        repo: RideRegistrationRepository,
        context_resolver: RideAttractionContextResolver,
        ...
        self._ride_attraction_admission_policy = (
            RideAttractionAdmissionContextResolverPolicy.create(self._metrics)
        )
