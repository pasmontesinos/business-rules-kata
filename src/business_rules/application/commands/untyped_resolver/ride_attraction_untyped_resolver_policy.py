...
from business_rules.domain.untyped_resolver.policies.ride_attraction_admission_untyped_resolver_policy import (
...
class RideAttractionUntypedResolverPolicyCommandHandler(RideAttractionCommandHandler):
    def __init__(
        self,
        repo: RideRegistrationRepository,
        context_resolver: UntypedResolver,
        ...
        self._ride_attraction_admission_policy = (
            RideAttractionAdmissionUntypedResolverPolicy.create(self._metrics)
        )
